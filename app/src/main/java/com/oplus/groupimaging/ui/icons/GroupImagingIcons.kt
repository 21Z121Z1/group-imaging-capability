package com.oplus.groupimaging.ui.icons
...
// Inline the small icon subset this app uses so we don't ship the full material-icons-extended pack.
object GroupImagingIcons {
    val Collections: ImageVector by lazy {
        outlinedIcon("Outlined.Collections") {
            moveTo(20.0f, 4.0f)
    ...
    val Settings: ImageVector by lazy {
        outlinedIcon("Outlined.Settings") {
